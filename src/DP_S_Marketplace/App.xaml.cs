using DP_S_Marketplace.Activation;
using DP_S_Marketplace.Contracts.Services;
using DP_S_Marketplace.Core.Contracts.Services;
using DP_S_Marketplace.Core.Services;
using DP_S_Marketplace.Helpers;
using DP_S_Marketplace.Models;
using DP_S_Marketplace.Notifications;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<AboutMeViewModel>();
            services.AddTransient<AboutMePage>();
            services.AddTransient<ScriptMarketplaceViewModel>();
            services.AddTransient<ScriptMarketplacePage>();
    ...
    protected async override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        await App.GetService<IApiService>().InitializeAsync();
    }
}
